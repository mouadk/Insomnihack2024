...
public class ProcessBuilderMethodVisitor extends ClassVisitor {

    public ProcessBuilderMethodVisitor(ClassVisitor visitor){
    ...
    public static class ProcessImplStartMethodVisitor extends AdviceAdapter {
        ...
        protected void onMethodEnter() {
            Method mtd = new Method("check", "(Ljava/util/List;)V");
            Type tp = Type.getType(ProcessBuilderCheck.class);
